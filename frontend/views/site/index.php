        ...
        <div class="row no-gutters">
            ...
            <div class="col-xl-4 col-md-4">
                <div class="single_service">
                    ...
                    <p>Обратитесь за помощью к нам – вместе мы подберем модель.</p>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-6 col-md-6">
                            <div class="business_info">
                                ...
                                <h3>Гравировка</h3>
                                <p>Портреты, выполненные на гравировальном станке последнего поколения, полностью повторяют изображения на фотографиях.
                                </p>
                            </div>
                        </div>
                        <div class="col-xl-6 col-md-6">
