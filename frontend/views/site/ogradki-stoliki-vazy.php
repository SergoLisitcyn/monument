<?php
$this->title = 'Оградки, Столики и Вазы | Изготовление и установка памятников в Калининграде и области';
$this->registerMetaTag(['name' => 'description','content' => 'Оградки, Столики и Вазы ✔ Изготовление памятников на заказ ✔ Установка на всех кладбищах Калининграда и области ✔ Гарантия качества и индивидуальный подход.']);
?>
